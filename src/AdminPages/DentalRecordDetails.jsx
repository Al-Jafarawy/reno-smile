...
const DentalRecordDetails = () => {
  ...
  const appointmentRecord = appointments.filter(
    ...
    <>
      <div className="d-flex ps-2 pt-2">
        <Link to=".." relative="path">
          <Button variant="dark" className="mt-2 me-auto">
            Go Back
          </Button>
        </Link>
      </div>
      ...
      >
        <Row className="my-2">
          <Col className="text-center">
            <h2 className='text-primary fw-bold mt-4 fw-bold'>
              Reno Smile Clinic
            </h2>
            <p className="fw-bold">Abu Ubaid, Damanhour City,</p>
            <p className="fw-bold">Beheira</p>
            <p className="fw-bold">Contact : 01011347782</p>
          </Col>
        </Row>
        <hr />
        <Row className="my-4 text-center">
          ...
          <Col>
            ...
            <p className="">
              {new Date(appointmentRecord[0].date).toLocaleDateString("en-US", {
                month: "long",
                day: "numeric",
                year: "numeric",
              })}
        ...
        <Row className="my-4 text-center">
          <Col>
            ...
            <p className="">
              {new Date(
                `2000-01-01T${appointmentRecord[0].time}`
        ...
        <Row className="mt-5">
          <Col className="text-center">
            <h5 className='fw-bold mt-4 className="fw-bold"'>
              DR. GERARDO B. TOME JR. D.M.D
            </h5>

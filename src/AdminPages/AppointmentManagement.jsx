...
const AppointmentManagement = () => {
  ...
  const displayedCompletedAppointments = completedAppointments.filter(
      ...
      >
        <Row>
          <Col className="text-center">
            <h2 className='text-primary fw-bold mt-4 className="fw-bold"'>
              Reno Smile Clinic
            </h2>
            <p className="fw-bold">Abu Ubaid,</p>
            <p className="fw-bold">Damanhour City, Beheira</p>
            ...
            <tbody>
              {displayedCompletedAppointments.map((appointment, index) => (
                <tr key={appointment.id}>
                  ...
                  <td>{Math.ceil(Math.random() * 1000)} EG</td>
                  <td>
                    <Link to={`/admin/records/${appointment.id}`}>

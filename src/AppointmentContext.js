...
export const AppointmentProvider = ({ children }) => {
  ...
  const handleEditAppointment = (id, name) => {
    ...
    if (
      ...
      if (isDuplicate) {
        setErrorMessage(
          "Another appointment already exists at the selected date and time. Please choose a different date or time."
        );
    ...
    if (pathname === "/admin") {
      ...
      const message = `Hi ${firstName}, Your appointment has been rescheduled to ${new Date(
        date
